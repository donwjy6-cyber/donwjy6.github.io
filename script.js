...
const second = 1000,
  ...
  hour = minute * 60,
  day = hour * 24;
let countDown = new Date('Feb 17, 2026 23:59:00').getTime(),
...
new TypeIt("#teks1", {
  strings: ["Happy Birthday my Dear,", " You deserve to have the best day ever", "I just wish I could be there for it", "No matter the miles that separate us, you're always with me in spiritIf you live to be a hundred, I want to live to be a hundred minus one day so I never have to live without you" , ""],
  startDelay: 4000,
  speed: 75,
...
new TypeIt("#teks2", {
  strings: ["With or without me, may the universe always make you happy no matter what", " ", "thank you for sticking around this far", " ", "- Wish all you the best"],
  startDelay: 2000,
  speed: 75,
  waitUntilVisible: true
}).go();
